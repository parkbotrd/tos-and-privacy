...
### 주석
- (i) 당사는 귀하의 채팅내역을 귀하가 탈퇴처리 하기 전까지 보관합니다. 당사는 해당 데이터를 실험용 데이터(또는 이에 국한되지 않음)으로 쓸 수 있으며, 해당 데이터가 감정 분석(또는 이에 국한되지 않음)을 위해 제삼자( 예) 구글 Natural Language API, 또는 이에 국한되지 않음)에게 제공될 수 있습니다. 귀하의 모든 채팅 기록은 판매되지 않습니다.
