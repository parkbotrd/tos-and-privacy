...
해당 약관에서 개인정보 처리방침(개인정보 보호 정책)과 의견이 엇갈리는 부분이 있을 수 있습니다. 이 때 유저는 `Team. Callisto 내의 파크봇` (이하 “회사”) 에게 우선 순위를 물어봐야하며, 이를 물어보지 않아 생기는 책임은 전부 유저 귀속입니다.

# 제1장 총칙
## 제1조 (목적)

이 약관은 회사 디스코드 또는 기타 플랫폼의 챗봇 서비스 및 이에 부수하는 네트워크, 웹사이트, API, 기타 서비스(이하 “서비스”)의 이용에 대한 회사와 서비스 이용자의 권리ㆍ의무 및 책임 사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
⑤ 챗봇을 초대할 경우 챗봇은 사용자의 서버에 `/명령어`를 별도의 동의를 구하지 않고 만들 수 있습니다.
...
⑮ 기타 면책 사항은 [SLA문서](https://parkbot./docs/sla)를 참고하십시오.
